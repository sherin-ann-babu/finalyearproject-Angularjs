                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="<?php echo base_url();?>Admincontroller/companyview">Companytable</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <!-- <h4 class="card-title">Companytable</h4> -->
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                ?> 
                                                <tr><td><?php echo $row->companyname; ?></td>
                                                ...
                                                <?php if($row->status==0){ ?>
                                                    <td><a href="<?php echo base_url(); ?>Admincontroller/approvecompany/<?php echo $row->comloginid;?>"class="btn btn-success">Approve </a></td>
                                                   <td><a href="<?php echo base_url(); ?>Admincontroller/rejectcompany/<?php echo $row->comloginid; ?>"class="btn btn-danger">Reject</a></td>
