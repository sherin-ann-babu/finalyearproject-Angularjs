                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Contractortable</h4>
                            <!-- <span class="ml-1">Contractortable</span> -->
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Table</a></li>
                            <li class="breadcrumb-item active"><a href="<?php echo base_url();?>Admincontroller/contractorview">Contractortable</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <!-- <h4 class="card-title">Contractortable</h4> -->
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr><td><?php echo $row->name; ?></td>
                                                    ...
                                                    <?php if($row->status==0){ ?>
                                                    <td><a href="<?php echo base_url(); ?>Admincontroller/approvecontractor/<?php echo $row->contloginid;?>"class="btn btn-success">Approve </a></td>
                                                   <td><a href="<?php echo base_url(); ?>Admincontroller/rejectcontractor/<?php echo $row->contloginid; ?>"class="btn btn-danger">Reject</a></td>
                                                  <?php } elseif($row->status==1){ ?>
                                                    <td><i class="btn btn-primary">Approved</i></td>
                                                    <td><a href="<?php echo base_url(); ?>Admincontroller/rejectcontractor/<?php echo $row->contloginid; ?>"class="btn btn-danger">Reject</a></td>
                                                  <?php } else { ?>
