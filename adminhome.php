...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>admin/./vendor/owl-carousel/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>admin/./vendor/owl-carousel/css/owl.theme.default.min.css">
    <link href="<?php echo base_url();?>admin/./vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
...
<body>
                                        ...
                                        <div class="item">
                                            <div class="testimonial-content">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <img class="testimonial-author-img ml-3" src="<?php echo base_url();?>admin/./images/avatar/1.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="item">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img width="35" src="<?php echo base_url();?>admin/./images/avatar/1.png" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>Lew Shawon</td>
    ...
    ***********************************-->
    ...
    <!-- Vectormap -->
    <script src="<?php echo base_url();?>admin/./vendor/raphael/raphael.min.js"></script>
    <script src="./vendor/morris/morris.min.js"></script>


    <script src="<?php echo base_url();?>admin/./vendor/circle-progress/circle-progress.min.js"></script>
    <script src="<?php echo base_url();?>admin/./vendor/chart.js/Chart.bundle.min.js"></script>

    <script src="<?php echo base_url();?>admin/./vendor/gaugeJS/dist/gauge.min.js"></script>
    ...
    <!-- Owl Carousel -->
    <script src="<?php echo base_url();?>admin/./vendor/owl-carousel/js/owl.carousel.min.js"></script>

    <!-- Counter Up -->
    <script src="<?php echo base_url();?>admin/./vendor/jqvmap/js/jquery.vmap.min.js"></script>
    <script src="<?php echo base_url();?>admin/./vendor/jqvmap/js/jquery.vmap.usa.js"></script>
    <script src="<?php echo base_url();?>admin/./vendor/jquery.counterup/jquery.counterup.min.js"></script>


    <script src="<?php echo base_url();?>admin/./js/dashboard/dashboard-1.js"></script>
