                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Notification table</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                ?> 
                                                <tr><td><?php echo $row->notification; ?></td>
                                                    <td><?php echo $row->postedon; ?></td>
                                                    
                                                    
                                                <td><a href="<?php echo base_url();?>Admincontroller/editnotificationdetails/<?php echo $row->notid; ?>"class="btn btn-success">Edit </a></td>
                                                <td><a href="<?php echo base_url(); ?>Admincontroller/deletenotificationdetails/<?php echo $row->notid;?>"class="btn btn-danger">Delete </a></td>
