                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>User Table</h4>
                            <!-- <span class="ml-1">  Usertable</span> -->
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Table</a></li>
                            <li class="breadcrumb-item active"><a href="<?php echo base_url();?>Admincontroller/tb">Usertable</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr><td><?php echo $row->name; ?></td>
                                                    ...
                                                    <?php if($row->status==0){ ?>
                                                    <td><a href="<?php echo base_url(); ?>Admincontroller/approveuser/<?php echo $row->loginid;?>" class="btn btn-success">Approve </a></td>
                                                   <td><a href="<?php echo base_url(); ?>Admincontroller/rejectuser/<?php echo $row->loginid; ?>" class="btn btn-danger">Reject</a></td>
