            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <!-- <h4 class="card-title">Tender Adding</h4> -->
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="<?php echo base_url();?>Admincontroller/tenderaddinsert">

                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Tender Type</label>
                                                <select id="inputState" name="tendertype"class="form-control" required>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="tendername" class="form-control" placeholder="Tender Name" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Amount</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="date" name="lastdateforapply"class="form-control" placeholder="Last date for apply" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label>Other Details</label>
                                                <input type="text" name="otherdetails" class="form-control" placeholder="Other Details" required>
