                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <!-- <span class="ml-1">Edit Notification</span> -->
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="<?php echo base_url();?>Admincontroller/updatenotificationdetails">
                                        <?php foreach ($data as $row ) 
                                        { ?>
                                    <input type="hidden" name="id" value="<?php echo $row->notid; ?>">
                                        
                                            
                                            <div class="form-group col-md-6">
                                                <label>Notification</label>
                                                <input type="text" name="notification" class="form-control" value="<?php echo $row->notification; ?>" placeholder="">
                                            </div>
