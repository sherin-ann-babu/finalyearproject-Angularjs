                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <!-- <span class="ml-1">Product Category table</span> -->
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Table</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">productcategorytable</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr><td><?php echo $row->category; ?></td>
                                                    ...
                                                    <td><a href="<?php echo base_url(); ?>Admincontroller/editproductcategory/<?php echo $row->pid;?>"class="btn btn-success">Edit </a></td>
                                                <td><a href="<?php echo base_url(); ?>Admincontroller/deleteproductcategory/<?php echo $row->pid; ?>"class="btn btn-danger">Delete</a></td>
