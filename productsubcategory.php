                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="<?php echo base_url();?>Admincontroller/productsubcategoryinsert">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="subcategory" class="form-control" placeholder="Product subcategory">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Tax amount</label>
                                                <input type="text" name="taxamount" class="form-control" placeholder="Tax amount">
                                            </div>
