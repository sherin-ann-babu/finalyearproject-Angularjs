...
<body>
    ...
    ***********************************-->
                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="<?php echo base_url();?>Admincontroller/updateproductsubcategory">
    ...
    { ?>
                                                    <option value="<?php echo $row->pid;?>"><?php echo $row->category;?></option>
	...
	{ ?>       
		...
		<input type="hidden" name="id" value="<?php echo $row->psid; ?>">
                                               
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Product subcategory</label>
                                                <input type="text" name="subcategory" class="form-control" value="<?php echo $row->subcategory; ?>" placeholder="Product subcategory">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Tax amount</label>
                                                <input type="text" name="taxamount" class="form-control" value="<?php echo $row->taxamount; ?> " placeholder="Tax amount">
                                            </div>
