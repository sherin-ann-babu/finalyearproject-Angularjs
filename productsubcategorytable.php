                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Product Sub Category table</h4>
                            <!-- <span class="ml-1">Product Sub Category table</span> -->
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <td><?php echo $row->taxamount; ?></td>
                                                    ...
                                                    <td><a href="<?php echo base_url(); ?>Admincontroller/editproductsubcategory/<?php echo $row->psid;?>"class="btn btn-success">Edit </a></td>
                                                <td><a href="<?php echo base_url(); ?>Admincontroller/deleteproductsubcategory/<?php echo $row->psid; ?>"class="btn btn-danger">Delete</a></td>
