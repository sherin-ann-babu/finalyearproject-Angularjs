...
<head>
    ...
    <!-- Datatable -->
    <link href="<?php echo base_url();?>admin/./vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <!-- Custom Stylesheet -->
...
<body>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Tender Table</h4>
                            <!-- <span class="ml-1">Tendertable</span> -->
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <!-- <h4 class="card-title">Tender table</h4> -->
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr><td><?php echo $row->tendertype; ?></td>
                                                  ...
                                                  <?php if($row->tendertype=="Open Tender") { ?><td><a href="<?php echo base_url(); ?>Contractorcontroller/tenderapply/<?php echo $row->tid;?>" ></a></td>
        <?php }else{ ?>
         <td><a href="<?php echo base_url(); ?>Admincontroller/tenderclosedadd/<?php echo $row->tid;?>" class="btn btn-link">Date</a></td>
         <?php } ?>  
                                                <td><a href="<?php echo base_url(); ?>Admincontroller/edittender/<?php echo $row->tid;?>"class="btn btn-success">Edit </a></td>
                                                <td><a href="<?php echo base_url(); ?>Admincontroller/deletetender/<?php echo $row->tid; ?>"class="btn btn-danger">Delete</a></td>
                                                <td><a href="<?php echo base_url(); ?>Admincontroller/viewapplication/<?php echo $row->tid;?>"class="btn btn-primary">View Application</a></td>
    ...
    ***********************************-->
    ...
    <script src="<?php echo base_url();?>admin/./js/plugins-init/datatables.init.js"></script>
