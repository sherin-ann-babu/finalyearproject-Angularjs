                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                ?> 
                                                <tr><td><?php echo $row->contloginid; ?></td>
                                                    <td><?php echo $row->name; ?></td>
                                                    <td><?php echo $row->address ;?></td>
                                                    <td><?php echo $row->pincode; ?></td>
                                                    <td><?php echo $row->tamount ; ?></td>
                                                    <?php if($row->prevworkdata!=null)
                                                    {
                                                     ?>
                                                <td><a href="<?php echo base_url();?>uploads/<?php echo $row->prevworkdata;?>"target="_blank">Prev work data download</a></td>
                                                    <?php
                                                    }?>
                                                    <?php if($row->tstatus==0){ ?>
                                                    <td><a href="<?php echo base_url(); ?>Admincontroller/accepttender/<?php echo $row->taid;?>"class="btn btn-success">Accept </a></td>
                                                    <?php } else { ?>
         <td>Accepted</td>
         <?php
                                                    }?>
